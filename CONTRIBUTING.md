# Contributing to my-linkmk-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
my-linkmk-schema. These guidelines are not strict rules.
...
The my-linkmk-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the my-linkmk-schema technical leads
...
[issues]: https://github.com/KIT/my-linkmk-schema/issues/
[pulls]: https://github.com/KIT/my-linkmk-schema/pulls/
